        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
              Data Analyst with 1.5 years of experience in data cleaning, EDA, dashboarding, and BI reporting using Python, SQL, Excel, Power BI and Tableau. Skilled at extracting actionable insights and automating workflows.
            </p>
            ...
            <div className="flex gap-4 pt-4">
              <Button 
                variant="ghost" 
                size="icon"
                className="hover:bg-neon-teal hover:text-white transition-all duration-300"
                asChild
              >
              ...
              <Button 
                variant="ghost" 
                size="icon"
                className="hover:bg-neon-blue hover:text-white transition-all duration-300"
                asChild
              >
              ...
              <Button 
                variant="ghost" 
                size="icon"
                className="hover:bg-neon-purple hover:text-white transition-all duration-300"
                asChild
              >
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <img
                src="/lovable-uploads/8500fd40-403a-410d-8470-98540666fc57.png"
                alt="Yukta Gupta"
                className="relative w-80 h-80 lg:w-96 lg:h-96 object-cover rounded-full border-4 border-primary shadow-2xl hover:scale-105 transition-transform duration-300"
              />
            </div>
          </div>
        </div>
